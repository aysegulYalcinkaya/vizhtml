 ...
 * </p>
 */
public class ScatterChart extends LineScatterChartBase {

    static {
        try {
            // Get template
            InputStream inputStream = ScatterChart.class.getClassLoader().getResourceAsStream("com/ariscience/vizhtml/template/plotly/lineScatterTemplate.html");
